...
export const metadata: Metadata = {
  title: {
    default: "Skill Workshop Management System — Expert-Led Workshops in Bangladesh",
    absolute: "Skill Workshop Management System — Expert-Led Workshops in Bangladesh",
  },
  description:
  ...
  openGraph: {
    title: "Skill Workshop Management System — Expert-Led Workshops in Bangladesh",
    description:
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <div className="site-container relative z-10 -mb-6 pt-6">
          <Breadcrumbs />
        </div>
        {children}
      </main>
