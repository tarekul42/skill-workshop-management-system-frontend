...
function Textarea({ className, error, ...props }: TextareaProps) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        "flex w-full min-h-[120px] rounded-[10px] border-[1.5px] border-border bg-background px-[14px] py-3 text-[15px] font-body transition-[border-color,box-shadow] duration-150 placeholder:text-foreground-muted focus:border-primary focus:outline-none focus:ring-[3px] focus:ring-primary/12 disabled:cursor-not-allowed disabled:bg-surface-3 disabled:opacity-65 resize-y",
